...
/* GET products listing with query filters:
   - title: includes (case-insensitive)
   - slug: exact match
   - minPrice, maxPrice: numeric filters
*/
// Example: /products?title=hoodie&minPrice=30&maxPrice=100&slug=some-slug
router.get("/", function (req, res, next) {
  const { title, slug, minPrice, maxPrice } = req.query;
